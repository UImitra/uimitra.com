...
const PrivacyPolicyPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Privacy Policy | Data Protection & Privacy Information | Uimitra</title>
        <meta name="description" content="Learn about Uimitra's privacy policy, data protection practices, and how we safeguard your personal information. Understand your rights and how we handle your data." />
        <meta name="keywords" content="privacy policy, data protection, personal data, GDPR compliance, data security, privacy rights, data processing, Uimitra privacy, information security, data collection" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://uimitra.com/privacy-policy" />
        <meta property="og:title" content="Privacy Policy | Data Protection & Privacy Information | Uimitra" />
        <meta property="og:description" content="Learn about Uimitra's privacy policy, data protection practices, and how we safeguard your personal information. Understand your rights and how we handle your data." />
        <meta property="og:image" content="https://uimitra.com/favicon-uimitra.svg"/>
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://uimitra.com/privacy-policy" />
        <meta name="twitter:title" content="Privacy Policy | Data Protection & Privacy Information | Uimitra" />
        <meta name="twitter:description" content="Learn about Uimitra's privacy policy, data protection practices, and how we safeguard your personal information. Understand your rights and how we handle your data." />
