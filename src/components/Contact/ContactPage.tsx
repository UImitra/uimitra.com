...
const ContactPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Uimitra | Get Expert Digital Solutions | Reach Out Today</title>
        <meta name="description" content="Contact Uimitra for professional UI/UX design, brand development, digital marketing, and social media services. Let's create something amazing together." />
        <meta name="keywords" content="contact Uimitra, UI/UX design services, brand development contact, digital marketing consultation, social media services contact, professional design contact" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://uimitra.com/contact" />
        <meta property="og:title" content="Contact Uimitra | Get Expert Digital Solutions | Reach Out Today" />
        <meta property="og:description" content="Contact Uimitra for professional UI/UX design, brand development, digital marketing, and social media services. Let's create something amazing together." />
        <meta property="og:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://uimitra.com/contact" />
        <meta name="twitter:title" content="Contact Uimitra | Get Expert Digital Solutions | Reach Out Today" />
        <meta name="twitter:description" content="Contact Uimitra for professional UI/UX design, brand development, digital marketing, and social media services. Let's create something amazing together." />
        <meta name="twitter:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://uimitra.com/contact" />
      </Helmet>
            ...
            <div className="space-y-6">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-dark group-hover:text-primary transition-colors duration-300">info@uimitra.com</p>
                </div>
              </motion.a>

              <motion.a 
                href="tel:+91 9724823602"
                className="flex items-center gap-4 group cursor-pointer"
                whileHover={{ x: 5 }}
              >
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-dark group-hover:text-primary transition-colors duration-300">+91 97248 23602</p>
                </div>
              </motion.a>
              ...
              >
                ...
                <div>
                  <p className="text-sm text-dark/60">Address</p>
                  <p className="text-dark group-hover:text-primary transition-colors duration-300 max-w-xs">
