...
const TechnologiesPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Our Technology Stack & Tools | Uimitra</title>
        <meta name="description" content="Explore Uimitra's cutting-edge technology stack and tools. From UI/UX design to digital marketing, we leverage the best technologies to deliver exceptional results." />
        <meta name="keywords" content="technology stack, design tools, digital marketing tools, UI/UX tools, brand design tools, social media tools, Uimitra technologies" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://uimitra.com/technology" />
        <meta property="og:title" content="Our Technology Stack & Tools | Uimitra" />
        <meta property="og:description" content="Explore Uimitra's cutting-edge technology stack and tools. From UI/UX design to digital marketing, we leverage the best technologies to deliver exceptional results." />
        <meta property="og:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://uimitra.com/technology" />
        <meta name="twitter:title" content="Our Technology Stack & Tools | Uimitra" />
        <meta name="twitter:description" content="Explore Uimitra's cutting-edge technology stack and tools. From UI/UX design to digital marketing, we leverage the best technologies to deliver exceptional results." />
        <meta name="twitter:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://uimitra.com/technology" />
      </Helmet>
