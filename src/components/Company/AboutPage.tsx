...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Uimitra | Leading Digital Innovation & Technology Solutions</title>
        <meta name="description" content="Discover Uimitra's journey, values, and commitment to excellence in digital innovation. With 5+ years of experience, our expert team delivers cutting-edge solutions that transform businesses." />
        <meta name="keywords" content="Uimitra, digital innovation, technology solutions, software development, UI/UX design, web development, mobile apps, company values, tech expertise, digital transformation" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://uimitra.com/company/about" />
        <meta property="og:title" content="About Uimitra | Leading Digital Innovation & Technology Solutions" />
        <meta property="og:description" content="Discover Uimitra's journey, values, and commitment to excellence in digital innovation. With 5+ years of experience, our expert team delivers cutting-edge solutions that transform businesses." />
        <meta property="og:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://uimitra.com/company/about" />
        <meta name="twitter:title" content="About Uimitra | Leading Digital Innovation & Technology Solutions" />
        <meta name="twitter:description" content="Discover Uimitra's journey, values, and commitment to excellence in digital innovation. With 5+ years of experience, our expert team delivers cutting-edge solutions that transform businesses." />
        <meta name="twitter:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://uimitra.com/company/about" />
      </Helmet>
