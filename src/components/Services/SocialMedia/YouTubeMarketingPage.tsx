...
const YouTubeMarketingPage: React.FC = () => {
  ...
  const features = [
    {
      ...
      items: [
        ...
        "Build community engagement tactics"
      ]
    },
    {
      ...
      items: [
        ...
        "Master video scripting techniques"
      ]
    },
    {
      ...
      items: [
        ...
        "Develop cross-platform presence"
      ]
    },
    {
      ...
      items: [
        ...
        "Participate in creator workshops"
      ]
    }
  ];
  ...
  return (
    <>
      <Helmet>
        <title>YouTube Marketing Services | Video Content Growth | Uimitra</title>
        <meta name="description" content="Grow your YouTube channel with Uimitra's expert marketing services. We help creators and businesses increase views, subscribers, and engagement through strategic video content and channel optimization." />
        <meta name="keywords" content="youtube marketing, video marketing, youtube strategy, content creation, video optimization, youtube seo, channel growth, video content, youtube advertising, video production, Uimitra" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://uimitra.com/services/social-media/youtube" />
        <meta property="og:title" content="YouTube Marketing Services | Video Content Growth | Uimitra" />
        <meta property="og:description" content="Grow your YouTube channel with Uimitra's expert marketing services. We help creators and businesses increase views, subscribers, and engagement through strategic video content and channel optimization." />
        <meta property="og:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://uimitra.com/services/social-media/youtube" />
        <meta name="twitter:title" content="YouTube Marketing Services | Video Content Growth | Uimitra" />
        <meta name="twitter:description" content="Grow your YouTube channel with Uimitra's expert marketing services. We help creators and businesses increase views, subscribers, and engagement through strategic video content and channel optimization." />
        <meta name="twitter:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://uimitra.com/services/social-media/youtube" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto px-6 md:px-12">
            ...
            <div className="grid grid-cols-1 gap-12">
              {features.map((feature, index) => (
                <motion.div
                  key={index}
                  className="bg-white rounded-2xl p-8 shadow-sm border border-primary/10 relative overflow-hidden"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.5, delay: index * 0.1 }}
                  viewport={{ once: true }}
                  whileHover={{ y: -5, boxShadow: "0 25px 50px rgba(237, 24, 79, 0.15)", borderColor: "rgba(237, 24, 79, 0.4)", transition: { duration: 0.2 } }}
                >
                  {/* Background Gradient */}
                  ...
                  <div className="flex flex-col lg:flex-row gap-8 relative z-10">
                    <div className="lg:w-1/3">
                      ...
                      <p className="text-dark/70 text-lg mb-6 lg:mb-0">{feature.description}</p>
                    </div>
                    ...
                    <div className="lg:w-2/3">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {feature.items.map((item, idx) => (
                          <motion.div
                            key={idx}
                            className="flex items-start gap-3 p-4 rounded-xl bg-light/50 border border-primary/5"
                            initial={{ opacity: 0, x: -20 }}
                            ...
                            whileHover={{ 
                              scale: 1.02, 
                              backgroundColor: "rgba(237, 24, 79, 0.05)",
