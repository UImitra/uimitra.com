...
const EmailMarketingPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Email Marketing Services | Newsletter & Campaign Management | Uimitra</title>
        <meta name="description" content="Transform your email marketing with Uimitra's professional services. We create engaging newsletters, automated campaigns, and data-driven strategies to boost your ROI." />
        <meta name="keywords" content="email marketing, newsletter design, email campaigns, email automation, email strategy, campaign management, email ROI, subscriber engagement, email analytics, drip campaigns, Uimitra" />
        
        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://uimitra.com/services/digital-marketing/email-marketing" />
        <meta property="og:title" content="Email Marketing Services | Newsletter & Campaign Management | Uimitra" />
        <meta property="og:description" content="Transform your email marketing with Uimitra's professional services. We create engaging newsletters, automated campaigns, and data-driven strategies to boost your ROI." />
        <meta property="og:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:url" content="https://uimitra.com/services/digital-marketing/email-marketing" />
        <meta name="twitter:title" content="Email Marketing Services | Newsletter & Campaign Management | Uimitra" />
        <meta name="twitter:description" content="Transform your email marketing with Uimitra's professional services. We create engaging newsletters, automated campaigns, and data-driven strategies to boost your ROI." />
        <meta name="twitter:image" content="https://uimitra.com/favicon-uimitra.svg" />
        
        {/* Additional SEO */}
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://uimitra.com/services/digital-marketing/email-marketing" />
      </Helmet>
